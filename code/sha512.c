...
/* SHA-512 初始哈希值 */
static const u64 g_sha512InitValues[8] = {
    0x6A09E667F3BCC908ULL, 0xBB67AE8584CAA73BULL, 0x3C6EF372FE94F82BULL, 0xA54FF53A5F1D36F1ULL,
    0x510E527FADE682D1ULL, 0x9B05688C2B3E6C1FULL, 0x1F83D9ABFB41BD6BULL, 0x5BE0CD19137E2179ULL
};

/* SHA-512 常数表 (前 80 项) */
static const u64 g_sha512Constants[80] = {
    ...
    0x650A73548BAF63DEULL, 0x766A0EBB3C3A8A3CULL, 0x81C2C92E47EDAEE6ULL, 0x92722C851482353BULL,
    0xA2BFE8A14CF10364ULL, 0xA81A664BBC423001ULL, 0xC24B8B70D0F89791ULL, 0xC76C51A30654BE30ULL,
    0xD192E819D6EF5218ULL, 0xD69906245565A910ULL, 0xF40E3585771A0393ULL, 0x106AA07032BBD1B8ULL,
    0x19A4C116B8D2D0C8ULL, 0x1E376C082DCC7021ULL, 0x2748774CDF8EEB99ULL, 0x34B0BCB5E19B48A8ULL,
...
static void SHA512_ProcessBlock(const u8 blockData[128], SHA512_Context_S* context)
{
    ...
    for (int round = 0; round < 80; ++round) {
        ...
        if (round < 16) {
            ...
            u64 s0 = SHA512_RightRotate(scheduleWord[(round - 15) & 0x0F], 1) ^
                     SHA512_RightRotate(scheduleWord[(round - 15) & 0x0F], 8) ^
                     SHA512_RightShift(scheduleWord[(round - 15) & 0x0F], 7);
            u64 s1 = SHA512_RightRotate(scheduleWord[(round - 2) & 0x0F], 19) ^
                     SHA512_RightRotate(scheduleWord[(round - 2) & 0x0F], 61) ^
        ...
        u64 tempValue1 = stateValues[7] + SHA512_CapitalSigma1(stateValues[4]) +
                        SHA512_Choose(stateValues[4], stateValues[5], stateValues[6]) +
